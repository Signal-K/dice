...
const CheckoutForm: React.FC = () => {
    return (
      <>
        ...
        <form action={`${API_URL}/api/stripe/create-checkout-individual-yearly-session`} method="POST" className="mt-8">
          <button className="button w-full py-3 bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 transition-all duration-300">
            Purchase yearly plan for an individual user
          </button>
        </form>
        ...
        <form action={`${API_URL}/api/stripe/create-checkout-team-yearly-session`} method="POST" className="mt-8">
          <button className="button w-full py-3 bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 transition-all duration-300">
            Purchase yearly plan for a team account
          </button>
        </form>
      </>
    );
